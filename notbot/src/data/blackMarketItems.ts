...
export const blackMarketItems: Record<string, BlackMarketItem> = {
    '1': { id: '1', name: 'Weed', price: 20000000000, currency: 'cash', description: 'This shop\'s currency, and are able to ~smoke it!', type: 'drug' },
    ...
    '4': { id: '4', name: 'Steroid', price: 5000000, currency: 'weed', description: 'Increases strength temporarily', type: 'drug' },
    '5': { id: '5', name: 'Anesthesia', price: 2000000, currency: 'weed', description: 'Numbs pain', type: 'drug' },
    '6': { id: '6', name: 'LSD', price: 15000000, currency: 'weed', description: 'Trippy effects', type: 'drug' },

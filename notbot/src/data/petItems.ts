...
export const shopItems: Record<string, ShopItem> = {
    ...
    '107': { id: '107', name: 'Opioid', price: 100, currency: 'cash', description: 'Quadruples Endurance' },
    '108': { id: '108', name: 'Steroid', price: 500, currency: 'cash', description: 'Quadruples Strength' },

...
export const items: Record<string, Item> = {
    ...
    '9': { id: '9', name: 'Rifle', price: '27000000000000', currency: 'beer', description: 'Select this weapon with ~select rifle', type: 'weapon' },
    '10': { id: '10', name: 'Rifle Bullet', price: '3000000000000', currency: 'beer', description: 'Ammunition for rifles', type: 'consumable' },
